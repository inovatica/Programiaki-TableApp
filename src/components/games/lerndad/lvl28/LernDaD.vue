<template>
  <div class="mainContainerMiddle" data-place="puzzle">
    ...
    <router-link :to="{name:'lerndad-lvl29'}" class="nextBtn"></router-link>
    <header>
      <p class="title">
    ...
    <div class="puzzleContainer clear-fix">
      <div id="gameContent">
        ...
        <div data-key="bs2" class="target" id="targetBlueSquare2"></div>
    ...
    data(){
      return {
        list: [
          ...
          {id: 'sourceBlueSquare2', key: "bs2", extraCss: "width: 100px; height: 100px;"},
        ],
        move: {
          gc: {x: 10, y: 10},
          bs: {x: 100, y: 100},
...
<style scoped>
  ...
  #sourceBlueSquare, #sourceBlueSquare2 {
    position: absolute;
  ...
  #targetBlueSquare, #targetBlueSquare2 {
    padding: 20px;

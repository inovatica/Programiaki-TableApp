  ...
  <div class="mainContainerMiddle" data-place="puzzle">
    ...
    <div class="puzzleContainer clear-fix">
      <div id="gameContent">
        ...
        <div data-key="gt" class="target" id="targetGreenTriangle"></div>
        <div data-key="rs" class="target" id="targetRedSquare"></div>
        <div data-key="bc" class="target" id="targetBlueCircle"></div>
      </div>
    </div>
    ...
    data(){
      return {
        list: [
          ...
          {id: 'sourceBlueCircle', key: "bc", extraCss: "width: 100px; height: 100px;"},
          {id: 'sourceGreenTriangle', key: "gt", extraCss: ""},

  ...
  <div class="mainContainerMiddle" data-place="puzzle">
    ...
    <div class="puzzleContainer clear-fix">
      <div id="gameContent">
        ...
        <div data-key="s2" class="target" id="targetSquare2"></div>
        <div data-key="t2" class="target" id="targetTriangle2"></div>
        <div data-key="c2" class="target" id="targetCircle2"></div>
      </div>
    </div>
...
<script>
  export default {
    data(){
      return {
        list: [
          {id: 'sourceSquare', key: "s", extraCss: "width: 100px; height: 100px;"},
          {id: 'sourceTriangle', key: "t", extraCss: ""},
          {id: 'sourceCircle', key: "c", extraCss: "width: 100px; height: 100px;"},
          {id: 'sourceSquare2', key: "s2", extraCss: "width: 100px; height: 100px;"},
          {id: 'sourceTriangle2', key: "t2", extraCss: ""},
          {id: 'sourceCircle2', key: "c2", extraCss: "width: 100px; height: 100px;"}
        ],
        move: {
          s: {x: 10, y: 10},
          t: {x: 200, y: 10},
...
<style scoped>
  ...
  #sourceSquare, #sourceSquare2 {
    position: absolute;
    background-color: rgba(0, 0, 255, 1);
    z-index: 10;
  }

  #sourceTriangle, #sourceTriangle2{
    position: absolute;
    z-index: 10;
    width: 0;
    height: 0;
  ...
  #targetTriangle, #targetTriangle2 {

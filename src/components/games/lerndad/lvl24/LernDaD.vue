<template>
  <div class="mainContainerMiddle" data-place="puzzle">
    ...
    <router-link :to="{name:'lerndad-lvl25'}" class="nextBtn"></router-link>
    <header>
      <p class="title">
    ...
    <div class="puzzleContainer clear-fix">
      <div id="gameContent">
        ...
        <div data-key="gs" class="target" id="targetGreenSquare"></div>
        <div data-key="rc" class="target" id="targetRedCircle"></div>
        <div data-key="bt" class="target" id="targetBlueTriangle"></div>
      </div>
    </div>
...
<script>
  export default {
    data(){
      return {
        list: [
          {id: 'sourceGreenSquare', key: "gs", extraCss: "width: 100px; height: 100px;"},
        ],
        move: {
          gs: {x: 10, y: 10}
        },
